...
public class InActiveUsers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_in_active_users);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                if (childObject.getString("email_verified").equals("0")) {
                                    ...
                                    expandableListAdapter = new InActiveUsersAdapter(getApplicationContext(),
    ...
    public boolean onSupportNavigateUp() {
        startActivity(new Intent(InActiveUsers.this, MainActivity.class));
